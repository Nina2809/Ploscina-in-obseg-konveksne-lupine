...
ki ima maksimalno razdaljo od $p_1$.
 ...
 Torej lahko za dano točko $p_1$ najdemo naslednje oglišče konveksne lupine $p_2$ tako, da preverimo vse točke $q \in S \setminus \lbrace p_1 \rbrace$ in izberemo tisto,
...
Po imlplementaciji zgoraj opisanega algoritma sva definirali obseg in ploščino. Obseg sva izračunali tako, da sva računali razdalje med točkami konveksne lupine in vrednosti med seboj seštevali. Ploščino pa sva izračunali tako, da sva implementirali znano formulo za določitev ploščino poljubnega lika imenovano Shoelace formula. 
